...
HD_PWD='X:/ec311/project/vga_testing/vga_testing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_square.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_square.tcl -notrace
