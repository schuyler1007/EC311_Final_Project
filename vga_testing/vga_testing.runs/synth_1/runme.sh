...
HD_PWD='X:/ec311/project/vga_testing/vga_testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_square.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_square.tcl
